...
public class ZeusWins extends JFrame implements ActionListener {
	public ZeusWins() {
		super(Main.title);
		...
		JLabel zeusWins = new JLabel("Zeus Wins");
		zeusWins.setFont(new Font("Baskerville Old Face", Font.BOLD, 31));
		zeusWins.setBounds(600, 100, 300, 40);
